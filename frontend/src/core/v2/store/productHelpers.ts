import { Badge, Category, Brand, Product, ProductVariation } from '../types';
...
export const normalizeProductImage = (rawImage: string = ""): string => {
...
const parseBadge = (badge: any = {}): Badge => ({
...
export const normalizeProductBadges = (product: any = {}): Badge[] => {
  const badges: Badge[] = [];
...
export const resolveCategoryName = (catValue: any): string => {
...
export const resolveBrandName = (brandValue: any): string => {
...
const normalizeBrand = (product: any = {}): string => {
...
export const mapRemoteProduct = (product: any = {}): Product => {
  ...
  if (Array.isArray(product.variants) && product.variants.length > 0) {
    ...
    variations = product.variants.map((v: any, idx: number) => {
...
export const getDefaultSelection = (product: Partial<Product> = {}): { size: string; concentration: string } => {
