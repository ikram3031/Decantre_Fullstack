  ...
  return (
    <div className={`min-h-screen py-12 sm:py-20 ${isLight ? 'bg-white text-black' : 'bg-[#050505] text-[#f5f5f5]'} transition-colors duration-500 text-left`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Luxury Top Header */}
        <div className={`text-center space-y-4 mb-16 relative py-12 border ${isLight ? 'border-zinc-200 bg-zinc-50' : 'border-[#C5A059]/15 bg-[#0a0a0a]/30'} rounded-none`}>
          <div className="absolute -inset-px bg-gradient-to-r from-transparent via-[#C5A059]/5 to-transparent pointer-events-none"></div>
          <span className="text-[10px] uppercase tracking-[0.4em] text-[#C5A059] font-sans font-medium block">Vanity Collection</span>
          <h1 className="text-3xl sm:text-5xl font-serif font-light tracking-wide uppercase">
            YOUR WISH-LIST
          </h1>
          <p className="text-zinc-500 text-xs sm:text-sm font-sans font-light max-w-xl mx-auto leading-relaxed px-4">
            Welcome to your private sanctuary of desired formulations. Review your saved masterpiece essences, customize volume ratios, or transfer them directly to your collection vault.
          </p>
        </div>
        ...
        {wishlistedProducts.length > 0 ? (
          <div className="space-y-8 animate-fade-in">
            <div className={`flex items-center justify-between border-b ${isLight ? 'border-zinc-200' : 'border-zinc-800'} pb-4`}>
              <span className="text-[10px] uppercase tracking-widest text-[#C5A059] font-semibold flex items-center gap-2">
                ...
                Your Selected Reserves ({wishlistedProducts.length})
              </span>
            </div>
          ...
          /* Empty Wishlist State + Elegant Curated Recommendations */
          <div className="space-y-16 animate-fade-in">
            <div className={`text-center py-16 border border-dashed ${isLight ? 'border-zinc-300 bg-zinc-50/50' : 'border-zinc-800 bg-zinc-900/10'} rounded-none max-w-2xl mx-auto`}>
              ...
              <h3 className="text-xl font-serif font-light text-zinc-400 mb-2">Sanctuary is Currently Empty</h3>
              <p className="text-zinc-500 text-xs font-sans font-light max-w-xs mx-auto leading-relaxed mb-6">
                You have not curated any liquid treasures to your favorites yet. Discover our premium formulations to find your signature aroma.
              </p>
              <Link
                to="/shop"
            ...
            {/* Curations/Recommendations */}
            <div className="space-y-8 pt-6">
              <div className={`flex flex-col gap-1.5 border-b ${isLight ? 'border-zinc-200' : 'border-zinc-800'} pb-4 text-center`}>
                <span className="text-[10px] uppercase tracking-[0.35em] text-[#C5A059] font-sans font-medium">Curations Selected For You</span>
                <h2 className="text-2xl font-serif font-light tracking-wide">Olfactory Masterpieces Selected For You</h2>
              </div>
