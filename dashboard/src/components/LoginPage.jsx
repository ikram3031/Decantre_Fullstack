        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-xl shadow-slate-100/50 overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-6 text-center border-b border-slate-100 bg-slate-50/50">
            <div className="mx-auto mb-3 flex items-center justify-center">
              <DecantreLogo className="h-16 w-16 text-slate-950" strokeWidth={3.2} />
            </div>
            <h1 className="text-2xl font-bold text-black tracking-tight font-sans flex items-center justify-center gap-2">
              Decantre Admin
              <DecantreLogo className="h-7 w-7 text-black shrink-0" strokeWidth={3.5} />
            </h1>
