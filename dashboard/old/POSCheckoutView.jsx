...
/**
 * Full POS (Point of Sale) checkout view for creating in-store direct sales.
 * Includes customer selector, product catalog, cart, and payment options.
 */
export const POSCheckoutView = ({
  // Close handler
  onClose,
  // Customer state
  customerType,
