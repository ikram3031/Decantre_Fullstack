...
import { CartItem } from "@/lib/core/order-utils";
...
export default function OrderDetailsPage() {
  ...
  // Status mapping to backend model values
  const getBackendStatus = (fullStatus: string) => {
      ...
      {!isEditMode ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Calculations and Billing summary */}
          ...
          {/* Customer / Payment details side panels */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          {/* Cart & Customer Information - Right panel */}
